	...
	<div class="boughtDiv">
		...
		<div class="orderListItem">
			<c:forEach items="${os }" var="o">
				<table class="orderListItemTable" orderStatus="${o.status}" orderId="${o.orderId}">
					<tr class="orderListItemFirstTR">
						...
						<td class="orderItemDeleteTD">
							<a class="deleteOrderLink" orderId="${o.orderId }" href="#nowhere">
					...
					<c:forEach items="${o.orderItems }" var="oi" varStatus="st">
						<tr class="orderItemProductInfoPartTR">
							<td class="orderItemProductInfoPartTD">
								<img width="80" height="80" src="img/productSingle_middle/${oi.product.productImage.imageId}.jpg">
							</td>
							<td class="orderItemProductInfoPartTD">
								<div class="orderListItemProductLinkOutDiv"><a href="foreproduct?productId=${oi.product.productId }">${oi.product.productName }</a></div>
							...
							<c:if test="${st.count==1 }">
								...
								<td valign="top" rowspan="${fn:length(o.orderItems)}" class="orderListItemButtonTD orderItemOrderInfoPartTD" width="100px">
	                                <c:if test="${o.status=='waitConfirm' }">
	                                    <a href="foreconfirmPay?orderId=${o.orderId }">
	                                        <button class="orderListItemConfirm">确认收货</button>
	                                    </a>
	                                </c:if>
	                                <c:if test="${o.status=='waitPay' }">
	                                    <a href="alipay.jsp?orderId=${o.orderId }&total=${o.total}">
	                                ...
	                                <c:if test="${o.status=='waitReview' }">
	                                    <a href="forereview?orderId=${o.orderId }">
