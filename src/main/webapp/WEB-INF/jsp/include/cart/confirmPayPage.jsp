...
<html>
	...
	<div class="confirmPayPageDiv">
		...
		<div class="confirmPayOrderInfoDiv">
			<div class="confirmPayOrderInfoText">我已经收到货，同意支付宝付款</div>
		</div>
		<div class="confirmPayOrderItemDiv">
			...
			<table class="confirmPayOrderItemTable">
				...
				<c:forEach items="${o.orderItems }" var="oi">
					<tr>
						<td><img src="img/productSingle_middle/${oi.product.productImage.imageId}.jpg"></td>
						<td class="confirmPayOrderItemProductLink">
							<a href="#nowhere">${oi.product.productName }</a>
						</td>
		...
		<div class="confirmPayOrderDetailDiv">
			<table class="confirmPayOrderDetailTable">
				...
				<tr>
					<td>收货信息</td>
					<td>${o.address }, ${o.receiver }, ${o.phone }, ${o.post }</td>
				</tr>
				<tr>
					<td>成交时间： </td>
		...
		<div class="confirmPayButtonDiv">
			...
			<a href="foreorderConfirmed?orderId=${o.orderId }"><button class="confirmPayButton">确认支付</button></a>
		</div>
